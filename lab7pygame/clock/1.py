...
sec = pg.image.load(r"C:\Users\user\Desktop\lab7pygame\leftarm.png").convert_alpha()
minute = pg.image.load(r"C:\Users\user\Desktop\lab7pygame\rightarm.png").convert_alpha()
rectsec = sec.get_rect()
rectmin = minute.get_rect()
rectmin.center = rectsec.center = midle

background = pg.image.load(r"C:\Users\user\Desktop\lab7pygame\mainclock.png")
run =True
